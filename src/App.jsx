...
export default function App() {
  ...
  const handleFloorPlanUploaded = (floorPlan) => {
    if (!currentProject) return;
    const updatedProject = { ...currentProject, floorPlan, status: 'measuring', updatedAt: new Date() };
  ...
  const uploadIframeRef = useRef(null);
  const measurementsIframeRef = useRef(null);
  const heatmapIframeRef = useRef(null);
  const createDialogIframeRef = useRef(null);
  ...
  const navigationItems = [
    ...
    { id: 'upload', label: 'Upload & Kalibrering', icon: Upload, disabled: !currentProject },
    { id: 'measurements', label: 'Målepunkter', icon: MapPin, disabled: !currentProject?.floorPlan },
    { id: 'heatmap', label: 'Heatmap', icon: Activity, disabled: !currentProject?.floorPlan },
    { id: 'report', label: 'Rapport & Eksport', icon: FileText, disabled: !currentProject },
  ];
